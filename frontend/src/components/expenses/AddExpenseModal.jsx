...
const AddExpenseModal = ({ isOpen, onClose, onSuccess, groupId, members }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (splitType === 'equal') {
        await expenseService.createEqualSplitExpense(
          groupId,
          parseInt(payerId),
          amountNum,
          description
      ...
      showSuccess('Wydatek został dodany');
      handleClose();
      if (onSuccess) onSuccess();
    } catch (error) {
      showError('Nie udało się dodać wydatku');
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-gray-900">Dodaj wydatek</h2>
            <button
              onClick={handleClose}
